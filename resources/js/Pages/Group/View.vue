            ...
            <div class="relative bg-white group dark:bg-gray-800">
                ...
                <div class="flex">
                    ...
                    >
                        ...
                        <template v-else>
                            ...
                            >
                                ...
                                <button
                                    @click="submitThumbnailImage(group)"
                    ...
                    <div class="flex-1 flex justify-between items-center p-4">
                        ...
                        <PrimaryButton
                            @click="joinGroup()"
                            v-if="authUser && !group.role && group.auto_approve"
                            >Join group
                        </PrimaryButton>
                    </div>
                </div>
                ...
                <TabGroup>
                    <TabList class="flex bg-white dark:bg-gray-800">
                        ...
                        <Tab
                            v-slot="{ selected }"
                            as="template"
                            v-if="isCurrentUserJoinGroup || isCurrentUserAdmin"
                        >
...
const deleteUser = (user) => {
    console.log(user)
    console.log(props.group.user_id)
    if (
        !window.confirm(
            `Are you sure you want to delete ${user.name} from group`
        )
    ) {
        return false;
    }
    ...
    form.delete(route("group.deleteUser", props.group.slug), {
        preserveScroll: true,
    });
};
</script>
